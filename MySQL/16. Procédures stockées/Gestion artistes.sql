...
drop table if exists ALBUM_ARCHIVE_01;
drop table if exists ALBUM_ARCHIVE_10;
drop table if exists ALBUM_ARCHIVE_20;
drop table if exists AUDITEUR;

create table if not exists AUDITEUR
(
	id_auditeur int NOT NULL AUTO_INCREMENT,
    nom_auditeur VARCHAR(200),
...
create table if not exists ALBUM_ARCHIVE_01
(
	id_album int NOT NULL AUTO_INCREMENT,
    nom_album VARCHAR(200),
    constraint pk_album_archive01 primary key(id_album)
);

create table if not exists ALBUM_ARCHIVE_10
(
	id_album int NOT NULL AUTO_INCREMENT,
    nom_album VARCHAR(200),
    constraint pk_album_archive10 primary key(id_album)
);

create table if not exists ALBUM_ARCHIVE_20
(
	id_album int NOT NULL AUTO_INCREMENT,
    nom_album VARCHAR(200),
    constraint pk_album_archive20 primary key(id_album)
);
